...
def generate_mnc_ranges():
    ...
    for i in range(0, 101):
        ranges.append(f"epdg.epc.mnc{i:03d}.mcc234.pub.3gppnetwork.org")
    # Second range: mnc0700 to mnc720
    for i in range(700, 721):
        ranges.append(f"epdg.epc.mnc{i:04d}.mcc234.pub.3gppnetwork.org")
    return ranges
...
def main():
    ...
    output_file = Path("res_unitedkingdom.txt")
